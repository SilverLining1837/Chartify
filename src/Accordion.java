...
public class Accordion extends JPanel implements ActionListener
{
    ...
    public static void main( String[] args )
    {
        ...
        outlookBar.addBar( "Variables and Comments", getDummyPanel( "Hahahahahah" ) );
        outlookBar.addBar( "If Statements", getDummyPanel( "Two" ) );
        outlookBar.addBar( "While Loops", getDummyPanel( "Three" ) );
        outlookBar.addBar( "For Loops", getDummyPanel( "Four" ) );
